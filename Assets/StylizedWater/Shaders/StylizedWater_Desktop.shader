...
Shader "StylizedWater/Desktop"
{
	Properties
	{
		...
		_NormalTiling("NormalTiling", Range( 0 , 100)) = 0.9
		_EdgeFade("EdgeFade", Range( 0.01 , 3)) = 0.2448298
		_RimSize("Rim Size", Range( 0 , 200)) = 6
		...
		_Depth("Depth", Range( 0 , 1000)) = 15
		_Wavesspeed("Waves speed", Range( 0 , 10)) = 0.75
		_WaveHeight("Wave Height", Range( 0 , 1)) = 0.05
		_WaveFoam("Wave Foam", Range( 0 , 100)) = 0
		_WaveSize("Wave Size", Range( 0 , 100)) = 0.1
