...
Shader "Water/ReflectiveBlendAnimated" {
    Properties {
...
//			half3 debugColor;
		...
		{
			half4 c = tex2D(_MainTex, float2(IN.uv_MainTex.x +(_WaveSpeed.x * _Time.x),IN.uv_MainTex.y+(_WaveSpeed.y * _Time.x)));
