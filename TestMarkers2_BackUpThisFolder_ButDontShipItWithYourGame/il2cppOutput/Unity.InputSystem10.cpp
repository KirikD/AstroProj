...
IL_0013_1:
			...
			}
			{
				...
				NullCheck(L_14);
				bool L_16;
				L_16 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(49 /* System.Boolean System.Type::IsAssignableFrom(System.Type) */, L_14, L_15);
				if (!L_16)
				{
					goto IL_0047_1;
				}
...
IL_0047_1:
			{
				...
				NullCheck(L_18);
				bool L_20;
				L_20 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(49 /* System.Boolean System.Type::IsAssignableFrom(System.Type) */, L_18, L_19);
				if (L_20)
				{
					goto IL_005b_1;
				}
